...
@section('content')
 ...
 <div class="hero-banner">
      <h1>Welcome to the Hero Banner</h1>
    </div>
     <div class="container">
                <div class="row">
                   <ul>
                   ...
                   </li><li>Annual OU Spring Football Media Guide (available only to media &amp; TDC members)
                   </li><li>Annual OU Fall Football Media Guide
